(function (global, factory) {
    ...
    (global = global || self, factory((global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire['remote-config'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common, global.firebase));
    ...
    ***************************************************************************** */
    ...
    var AngularFireRemoteConfig = /** @class */ (function () {
        ...
        platformId) {
             ...
             * @param {?} rc
             * @return {?}
             */ rc) { return rc.registerRemoteConfig && rc.registerRemoteConfig(( /** @type {?} */(firebase))); })), operators.map(( /**
             * @return {?}
